...
use \MonitoLib\require_once str_replace('_', DIRECTORY_SEPARATOR, $backendClass) . ';
use \MonitoLib\require_once str_replace('_', DIRECTORY_SEPARATOR, $frontendClass) . ';
use \MonitoPdf\Pdf\Zend\Cache\Zend_Cache_Exception;
/**
 * Zend Framework
 *
 * LICENSE
