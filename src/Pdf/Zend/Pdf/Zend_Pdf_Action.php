...
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_GoTo;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_GoToR;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_GoToE;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Launch;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Thread;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_URI;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Sound;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Movie;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Hide;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Named;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_SubmitForm;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_ResetForm;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_ImportData;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_JavaScript;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_SetOCGState;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Rendition;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Trans;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_GoTo3DView;
use \MonitoPdf\Pdf\Zend\Pdf\Action\Zend_Pdf_Action_Unknown;
/**
 * Zend Framework
 *
 * LICENSE
