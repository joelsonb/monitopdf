...
use \MonitoPdf\Pdf\Zend\Memory\Zend_Memory_Manager;
use \MonitoPdf\Pdf\Zend\Memory\Zend_Memory_Value;
use \MonitoPdf\Pdf\Zend\Memory\Zend_Memory_Container;
use \MonitoPdf\Pdf\Zend\Zend_Cache;
use \MonitoPdf\Pdf\Zend\Memory\Zend_Memory_Exception;
/**
 * Zend Framework
 *
 * LICENSE
...
class Zend_Memory
{
    ...
    public static function factory($backend, $backendOptions = array())
    {
        ...
        $backendClass = '\MonitoPdf\Pdf\Zend\Cache\Backend\Zend_Cache_Backend_' . $backend;
