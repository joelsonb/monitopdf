<?php
namespace MonitoPdf\Pdf\Zend\Cache\Backend\ZendServer;

use \MonitoPdf\Pdf\Zend\Cache\Backend\Zend_Cache_Backend_Interface;
use \MonitoPdf\Pdf\Zend\Cache\Backend\Zend_Cache_Backend_ZendServer;
/**
 * Zend Framework
 *
 * LICENSE
