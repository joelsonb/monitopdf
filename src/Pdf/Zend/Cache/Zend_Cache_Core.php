<?php
namespace MonitoPdf\Pdf\Zend\Cache;

use \MonitoPdf\Pdf\Zend\Zend_Log;
use \MonitoPdf\Pdf\Zend\Log\Writer\Zend_Log_Writer_Stream;
use \MonitoPdf\Pdf\Zend\Log\Filter\Zend_Log_Filter_Priority;
/**
 * Zend Framework
 *
 * LICENSE
